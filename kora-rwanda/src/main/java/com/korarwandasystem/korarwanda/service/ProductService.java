...
public class ProductService {
    ...
    public Product updateProduct(Long id, Product productDetails) {
        ...
        return productRepository.findById(id).map(product -> {
            ...
            if (productDetails.getArtisan() != null && productDetails.getArtisan().getArtisanId() != null) {
                artisanRepository.findById(productDetails.getArtisan().getArtisanId())
    ...
    public List<Product> getProductsByArtisanId(Long artisanId) {
        return productRepository.findByArtisanArtisanId(artisanId);
    }

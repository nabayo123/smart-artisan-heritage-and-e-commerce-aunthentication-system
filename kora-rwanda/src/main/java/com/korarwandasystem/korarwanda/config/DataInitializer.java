...
public class DataInitializer {
    ...
    CommandLineRunner init(
        ...
        return args -> {
            ...
            order1.setTotalAmount(new BigDecimal("40000.00"));
            ...
            order2.setTotalAmount(new BigDecimal("25000.00"));
            ...
            payment1.setPaymentMethod(PaymentMethod.MTN_MOMO);
            ...
            payment1.setUpdatedAt(LocalDateTime.now().minusDays(1));

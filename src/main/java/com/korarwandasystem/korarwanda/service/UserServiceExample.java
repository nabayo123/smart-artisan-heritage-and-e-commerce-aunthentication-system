...
public class UserServiceExample {
    ...
    public User createUserWithInvalidData() {
        User user = new User();
        user.setEmail(""); // Invalid - @NotBlank will fail
        user.setFirstName(""); // Invalid - @NotBlank will fail
        user.setPassword("123"); // Invalid - @Size(min=6) will fail
        user.setUserType(null); // Invalid - @NotNull will fail
